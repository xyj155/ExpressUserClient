...
public class SiteListActivity extends BaseActivity implements SiteListActivityContract.View, AMap.OnMarkerClickListener, AMap.OnMapClickListener {
    ...
    public void initView(Bundle savedInstanceState) {
        ...
        bottomSheetDialog = new BottomSheetDialog(SiteListActivity.this);
    ...
    public void initData() {
        ...
        if (ActivityCompat.checkSelfPermission(SiteListActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ActivityCompat.requestPermissions(SiteListActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 1);
            }
        }
        ...
        mlocationClient = new AMapLocationClient(SiteListActivity.this);
        ...
        myLocationStyle.myLocationIcon(BitmapDescriptorFactory.fromBitmap(convertViewToBitmap(View.inflate(SiteListActivity.this, R.layout.map_location_marker, null))));
        ...
        mlocationClient.setLocationListener(new AMapLocationListener() {
            ...
            public void onLocationChanged(AMapLocation aMapLocation) {
                if (aMapLocation == null) {
                    ...
                    siteListActivityPresenter.loadList(SiteListActivity.this, aMapLocation.getLatitude(), aMapLocation.getLongitude());
                }
            }
        });
        mlocationClient.setLocationOption(mLocationOption);
    ...
    private void customizeMarkerIcon(int url, final OnMarkerIconLoadListener listener) {
        final View markerView = LayoutInflater.from(SiteListActivity.this).inflate(R.layout.map_location_marker, null);
        final CircleImageView icon = (CircleImageView) markerView.findViewById(R.id.img_user_head);
        Glide.with(SiteListActivity.this)
                .load(url)
                .asBitmap()
                .thumbnail(0.2f)
    ...
    private class SiteListAdapter extends BaseQuickAdapter<POIGson.PoisBean, BaseViewHolder> {
        ...
        @Override
        protected void convert(BaseViewHolder helper, POIGson.PoisBean item) {
