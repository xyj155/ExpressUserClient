...
public class SwitchButton extends View implements Checkable {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        showText = optBoolean(typedArray,
                R.styleable.SwitchButton_sb_show_text,
                false);
    ...
    private void drawUnCheckText(Canvas canvas){
        drawUncheckText(canvas,
                uncheckCircleColor,
                right - dp2px(18), centerY+dp2px(5),
                paint);
    }
     ...
     * @param paint
     */
    protected void drawUncheckText(Canvas canvas,
                                        int color,
                                        float centerX, float centerY,
                                        Paint paint) {
        ...
        canvas.drawText("否",centerX, centerY, paint);
    }
     ...
     * @param paint
     */
    protected void drawcheckText(Canvas canvas,
                                   int color,
                                   float centerX, float centerY,
                                   Paint paint) {
        paint.setStrokeWidth(dp2px(1));
        ...
        paint.setTextSize(sp2px(14f));
        canvas.drawText("是",centerX, centerY, paint);
    }
